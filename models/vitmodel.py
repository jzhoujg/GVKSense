...
class Block(nn.Module):
    ...
    def forward(self, x):
        ...
        residual = x
        x = self.mlp_drop(self.act(self.mlp.fc1(self.norm2(x))))
        x = self.drop_path(self.mlp_drop(self.mlp.fc2(x)))
...
class VisionTransformer(nn.Module):
    ...
    def __init__(self, global_pool=False, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dim=768, depth=12,
                 ...
                 act_layer=None, weight_init='', tuning_config=None,dataset=''):
        super().__init__()
